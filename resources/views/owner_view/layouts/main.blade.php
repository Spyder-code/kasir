...
<head>
  ...
  <!-- Theme style -->
  <link rel="stylesheet" href="{{ asset('owner/css/adminlte.min.css') }}">
  <!-- overlayScrollbars -->
...
<div class="wrapper">
  ...
  <!-- Main Sidebar Container -->
   <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <img src="{{ asset('owner/img/AdminLTELogo.png') }}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
            style="opacity: .8">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
         <div class="image">
            <img src="{{ asset('owner/img/user2-160x160.jpg') }}" class="img-circle elevation-2" alt="User Image">
         </div>
         <div class="info">
            <a href="#" class="d-block">Nama Owner</a>
         </div>
      </div>
   ...
   <footer class="main-footer">
      ...
      {{-- <strong>Made by <i class="fas fa-heart"></i> from sidoarjo</strong> --}}
  ...
  <!-- jQuery -->
  <script src="{{ asset('owner/plugins/jquery/jquery.min.js') }}"></script>
  <!-- jQuery UI 1.11.4 -->
  <script src="{{ asset('owner/plugins/jquery-ui/jquery-ui.min.js') }}"></script>
  <!-- Resolve conflict in jQuery UI tooltip with Bootstrap tooltip -->
  <script>
    $.widget.bridge('uibutton', $.ui.button)
  </script>
  <!-- Bootstrap 4 -->
  <script src="{{ asset('owner/plugins/bootstrap/js/bootstrap.bundle.min.js') }}"></script>
  <!-- ChartJS -->
